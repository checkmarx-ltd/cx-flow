...
* If user is using Github Action value of should not be in double or single quotes. Example : If user want to exclude folder name abc he should pass parameter as `--checkmarx.exclude-folders=abc` 
