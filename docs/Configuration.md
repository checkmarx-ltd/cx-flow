...
| `project-summary`                      | false                 | No                                  | Yes     | Yes (Scan only)   | If set to `true`, When scanning with `restrict-results-to-branch` functionality. Get complete project summary results in PR with branch summary.                                                                                                                                                                                                                                                                                                                                        |
