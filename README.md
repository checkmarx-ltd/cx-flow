<img src="https://raw.githubusercontent.com/Checkmarx/ci-cd-integrations/main/.images/PluginBanner.jpg" alt="checkmarx-logo">
<br />
<div align="center">
...
<p align="center">
<br />
    <a href="https://github.com/checkmarx-ltd/cx-flow/issues/new/choose">Report Bug</a>
    ·
    <a href="https://github.com/checkmarx-ltd/cx-flow/issues/new/choose">Request Feature</a>
  </p>
</div>
...
## Documentation
For documentation [click here](https://github.com/checkmarx-ltd/cx-flow/wiki)
...
We appreciate feedback and contribution to the CxFlow ! Before you get started, please see the following:
...
This software is distributed under the Apache-2.0  —  See `LICENSE` for more information.
