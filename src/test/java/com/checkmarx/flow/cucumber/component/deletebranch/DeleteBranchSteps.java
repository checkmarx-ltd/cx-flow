...
public class DeleteBranchSteps {
    ...
    public DeleteBranchSteps(FlowProperties flowProperties, GitHubService gitHubService,
                             ...
                             ConfigurationOverrider configOverrider, ADOProperties adoProperties, ADOController adoController, EmailService emailService, BugTrackerEventTrigger bugTrackerEventTrigger) {
