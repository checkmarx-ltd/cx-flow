...
@XmlRootElement(name = "TestLdapServerConnection")
public class TestLdapServerConnection {
     ...
     *
     */
    public CxWSLdapServerConfiguration getServerConfiguration() {
     ...
     *
     */
    public void setServerConfiguration(CxWSLdapServerConfiguration value) {
