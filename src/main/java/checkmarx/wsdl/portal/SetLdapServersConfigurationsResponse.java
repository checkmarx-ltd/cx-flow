...
@XmlRootElement(name = "SetLdapServersConfigurationsResponse")
public class SetLdapServersConfigurationsResponse {

    @XmlElement(name = "SetLdapServersConfigurationsResult")
    ...
    public CxWSResponseLDAPServersConfiguration getSetLdapServersConfigurationsResult() {
        return setLdapServersConfigurationsResult;
    }
     ...
     *
     */
    public void setSetLdapServersConfigurationsResult(CxWSResponseLDAPServersConfiguration value) {
        this.setLdapServersConfigurationsResult = value;
    }
