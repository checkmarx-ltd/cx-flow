...
@XmlRootElement(name = "GetSharedFileSystemLayerResponse")
public class GetSharedFileSystemLayerResponse {

    @XmlElement(name = "GetSharedFileSystemLayerResult")
    ...
    public CxWSResponseFileSystemLayer getGetSharedFileSystemLayerResult() {
        return getSharedFileSystemLayerResult;
    }
     ...
     *
     */
    public void setGetSharedFileSystemLayerResult(CxWSResponseFileSystemLayer value) {
        this.getSharedFileSystemLayerResult = value;
    }
