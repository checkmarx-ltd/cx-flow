...
@XmlRootElement(name = "GetTeamSaaSPackageResponse")
public class GetTeamSaaSPackageResponse {

    @XmlElement(name = "GetTeamSaaSPackageResult")
    ...
    public CxWSResponseSaasPackage getGetTeamSaaSPackageResult() {
        return getTeamSaaSPackageResult;
    }
     ...
     *
     */
    public void setGetTeamSaaSPackageResult(CxWSResponseSaasPackage value) {
        this.getTeamSaaSPackageResult = value;
    }
