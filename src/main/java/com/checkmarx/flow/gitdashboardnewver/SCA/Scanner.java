...
import com.checkmarx.flow.gitdashboardnewver.Vendor__1;
...
public class Scanner {
    ...
    @Builder.Default
    private String id="Checkmarx-SCA";
    /**
    ...
    @Builder.Default
    private String name="Checkmarx-SCA";
    /**
    ...
    @Builder.Default
    private String url="http://sca.checkmarx.net/";
    /**
     ...
     */
    @JsonProperty("vendor")
    public com.checkmarx.flow.gitdashboardnewver.SCA.Vendor__1 getVendor() {
        return vendor;
    }
     ...
     */
    @JsonProperty("vendor")
    public void setVendor(com.checkmarx.flow.gitdashboardnewver.SCA.Vendor__1 vendor) {
        this.vendor = vendor;
    }
