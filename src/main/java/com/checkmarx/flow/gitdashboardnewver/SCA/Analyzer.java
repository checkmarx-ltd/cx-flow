...
import com.checkmarx.flow.gitdashboardnewver.Vendor;
...
public class Analyzer {
    ...
    @Builder.Default
    private URI url= URI.create("http://sca.checkmarx.net/");
    /**
     ...
     */
    @JsonProperty("vendor")
    public com.checkmarx.flow.gitdashboardnewver.SCA.Vendor getVendor() {
        return vendor;
    }
     ...
     */
    @JsonProperty("vendor")
    public void setVendor(com.checkmarx.flow.gitdashboardnewver.SCA.Vendor vendor) {
        this.vendor = vendor;
    }
