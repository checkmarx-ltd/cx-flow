...
import com.checkmarx.flow.gitdashboardnewver.Fix;
...
public class Remediation {
    ...
    private List<com.checkmarx.flow.gitdashboardnewver.Fix> fixes = null;
    /**
     ...
     */
    @JsonProperty("fixes")
    public List<com.checkmarx.flow.gitdashboardnewver.Fix> getFixes() {
        return fixes;
    }
