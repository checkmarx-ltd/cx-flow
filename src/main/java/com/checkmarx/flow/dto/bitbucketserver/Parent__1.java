...
public class Parent__1 {
    ...
    @JsonProperty("author")
    public Author__2 getAuthor() {
        return author;
    }

    @JsonProperty("author")
    public void setAuthor(Author__2 author) {
        this.author = author;
    }
    ...
    @JsonProperty("committer")
    public Committer__2 getCommitter() {
        return committer;
    }

    @JsonProperty("committer")
    public void setCommitter(Committer__2 committer) {
    ...
    @JsonProperty("parents")
    public List<Parent__2> getParents() {
        return parents;
    }

    @JsonProperty("parents")
    public void setParents(List<Parent__2> parents) {
