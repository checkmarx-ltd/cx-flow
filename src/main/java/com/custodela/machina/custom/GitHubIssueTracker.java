...
import com.custodela.machina.dto.github.LabelsItem;
...
public class GitHubIssueTracker implements IssueTracker {
    ...
    public GitHubIssueTracker(RestTemplate restTemplate, GitHubProperties properties, MachinaProperties machinaProperties) {
    ...
    public List<Issue> getIssues(ScanRequest request) {
        ...
        ResponseEntity<com.custodela.machina.dto.github.Issue[]> response = restTemplate.exchange(apiUrl,
                HttpMethod.GET, httpEntity, com.custodela.machina.dto.github.Issue[].class);
        if(response.getBody() == null){
            return new ArrayList<>();
        }
        for(com.custodela.machina.dto.github.Issue issue: response.getBody()){
        ...
        while (next != null) {
            ResponseEntity<com.custodela.machina.dto.github.Issue[]> responsePage = restTemplate.exchange(next, HttpMethod.GET,
                    httpEntity, com.custodela.machina.dto.github.Issue[].class);
    ...
    private Issue mapToIssue(com.custodela.machina.dto.github.Issue issue){
        if(issue == null){
            return null;
        }
        Issue i = new Issue();
    ...
    private Issue getIssue(String issueUrl) {
        ...
        HttpEntity httpEntity = new HttpEntity<>(createAuthHeaders());
        ResponseEntity<com.custodela.machina.dto.github.Issue> response =
                restTemplate.exchange(issueUrl, HttpMethod.GET, httpEntity, com.custodela.machina.dto.github.Issue.class);
    ...
    public Issue createIssue(ScanResults.XIssue resultIssue, ScanRequest request) throws MachinaException {
        ...
        try {
            ...
            response = restTemplate.exchange(apiUrl, HttpMethod.POST, httpEntity, com.custodela.machina.dto.github.Issue.class);
        }
            ...
            if(e.getStatusCode().equals(HttpStatus.GONE)){
                ...
                //throw new MachinaException("Error occurred while creating GitHub Issue");
                throw new MachinaRuntimeException();
            }
        }
        return mapToIssue(response.getBody());
    ...
    public Issue updateIssue(Issue issue, ScanResults.XIssue resultIssue, ScanRequest request) throws MachinaException {
        ...
        ResponseEntity<com.custodela.machina.dto.github.Issue> response;
        try {
            response = restTemplate.exchange(issue.getUrl(), HttpMethod.POST, httpEntity, com.custodela.machina.dto.github.Issue.class);
    ...
    private JSONObject getJSONUpdateIssue(ScanResults.XIssue resultIssue, ScanRequest request) {
        ...
        String body = ScanUtils.getMDBody(resultIssue, request.getBranch(), fileUrl, machinaProperties);
