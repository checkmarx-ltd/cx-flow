...
public class GitLabIssueTracker implements IssueTracker {
    ...
    public List<Issue> getIssues(ScanRequest request) {
        ...
        ResponseEntity<com.custodela.machina.dto.gitlab.Issue[]> response = restTemplate.exchange(endpoint,
                HttpMethod.GET, httpEntity, com.custodela.machina.dto.gitlab.Issue[].class, request.getRepoProjectId());
    ...
    private Issue mapToIssue(com.custodela.machina.dto.gitlab.Issue issue){
        if(issue == null){
            return null;
        }
        Issue i = new Issue();
    ...
    private Issue getIssue(Integer projectId, Integer iid) {
        ...
        HttpEntity httpEntity = new HttpEntity<>(createAuthHeaders());
        ResponseEntity<com.custodela.machina.dto.gitlab.Issue> response =
                restTemplate.exchange(endpoint, HttpMethod.GET, httpEntity, com.custodela.machina.dto.gitlab.Issue.class, projectId, iid);
    ...
    public Issue createIssue(ScanResults.XIssue resultIssue, ScanRequest request) throws MachinaException {
        ...
        try {
            ...
            response = restTemplate.exchange(endpoint, HttpMethod.POST, httpEntity, com.custodela.machina.dto.gitlab.Issue.class, request.getRepoProjectId());
        }
        catch (HttpClientErrorException e){
    ...
    private com.custodela.machina.dto.gitlab.Issue closeIssue(Integer projectId, Integer iid) {
        ...
        ResponseEntity<com.custodela.machina.dto.gitlab.Issue> response = restTemplate.exchange(endpoint, HttpMethod.PUT, httpEntity,
                com.custodela.machina.dto.gitlab.Issue.class, projectId, iid);
        return response.getBody();
    }
    ...
    private Issue updateIssue(JSONObject issue, Integer projectId, Integer iid) throws MachinaException {
        ...
        ResponseEntity<com.custodela.machina.dto.gitlab.Issue> response;
        try {
            response = restTemplate.exchange(endpoint, HttpMethod.PUT, httpEntity, com.custodela.machina.dto.gitlab.Issue.class, projectId, iid);
